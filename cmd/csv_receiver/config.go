...
func ParseConfig() Config {
	...
	// Security settings
	flag.StringVar(&cfg.Token, "token", os.Getenv("CSV_AUTH_TOKEN"), "Authentication token")
	...
	if cfg.Token == "" && !cfg.InsecureMode {
		log.Fatal("Authentication token is required. Use -insecure flag to run without authentication (not recommended)")
	}
